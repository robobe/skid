...
ImageConverter::ImageConverter(uint32_t width, uint32_t height,
                               const std::string &fourcc) : width_(width),
                                                            height_(height),
...
bool ImageConverter::convert(const std::string &msg,
...
bool ImageConverter::operator()(const std::string &msg,
                                ImageConverter::Buffer &buffer)
{
...
void ImageConverter::param_bgr24()
{
    ...
    cv_copy_encoding_ = "BGR8"; //sensor_msgs::image_encodings::BGR8;
    cv_color_ = false;
    bytes_per_line_ = 0;
...
void ImageConverter::param_grey()
{
    ...
    cv_copy_encoding_ = "MONO8";//sensor_msgs::image_encodings::MONO8;
    cv_color_ = false;
    bytes_per_line_ = 0;
...
void ImageConverter::param_yvu420()
{
    ...
    cv_copy_encoding_ = "BGR8"; //sensor_msgs::image_encodings::BGR8;
    cv_color_ = true;
    cv_color_code_ = cv:: COLOR_BGR2YCrCb;
